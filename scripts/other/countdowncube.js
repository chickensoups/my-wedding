    ...
    var helpers = { 
            ...
            ***********************************************************/
            ...
            this.classes = [ 'front','back', 'right', 'left', 'top', 'bottom' ];	
                    ...
                    this.topTagsDisplay = [ 'Năm', 'Tháng', 'Ngày','Giờ', 'Phút', 'Giây' ];
                    ...
                    for( var tagIndex in this.topTags )
                    {
                            ...
                            var tagDisplay = this.topTagsDisplay[ tagIndex ];
                            ...
                            element.children(':last').append('<div></div>').children(':last').html(tagDisplay).addClass('countdownCubeTitleDiv');
                    }
